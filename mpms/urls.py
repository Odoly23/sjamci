...
urlpatterns = [
    ...
    path('mpms/empresa/edit/<str:hashid>/', views.mpms_empresa_edit, name='mpms-empresa-edit'),
    ...
    path('mpms/avaliasaun/list/', views.avalia_list_mpms, name='ava-mpms-list'),
    path('mpms/avaliasaun/list/plan/', views.avalia_list2_mpms, name='ava-mpms-list2'),
    path('mpms/avaliasaun/antes/', views.baseline_list_mpms, name='ava-mpms-antes'),
    path('mpms/avaliasaun/depois/', views.monitoring_list_mpms, name='ava-mpms-depois'),
    path('mpms/avaliasaun/add/depois/<str:hashid>/', views.monitoring_create_mpms, name='monit-add'),
    path('mpms/avaliasaun/add/antes/<str:hashid>/', views.baseline_create_mpms, name='evaluate-add'),
